...
namespace Linphone
{
	namespace Core
	{
		...
		/// </summary>
		public interface class ILinphoneCoreListener
		{
		public:
			/// <summary>
			...
			void AuthInfoRequested(System::String^ realm, System::String^ username, System::String^ domain);
			...
			void GlobalState(GlobalState state, System::String^ message);
			...
			void CallState(LinphoneCall^ call, LinphoneCallState state, System::String^ message);
			...
			void RegistrationState(LinphoneProxyConfig^ config, RegistrationState state, System::String^ message);
			...
			void CallEncryptionChanged(LinphoneCall^ call, System::Boolean encrypted, System::String^ authenticationToken);
			...
			void LogUploadStatusChanged(LinphoneCoreLogCollectionUploadState state, System::String^ info);
