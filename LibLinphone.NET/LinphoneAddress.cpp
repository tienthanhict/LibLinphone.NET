...
String^ Linphone::Core::LinphoneAddress::Scheme::get()
{
	API_LOCK;
	return Linphone::Core::Utils::cctops(linphone_address_get_scheme(this->address));
}

void Linphone::Core::LinphoneAddress::DisplayName::set(String^ name)
{
	API_LOCK;
...
void Linphone::Core::LinphoneAddress::UserName::set(String^ username)
{
	API_LOCK;
...
void Linphone::Core::LinphoneAddress::Domain::set(String^ domain)
{
	API_LOCK;
