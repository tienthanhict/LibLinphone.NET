...
namespace Linphone
{
	namespace Core
	{
		...
		public:
			...
			/// </example>
			/// </summary>
			property System::String^ ServerAddr
			{
				System::String^ get();
			...
			/// </summary>
			property System::Boolean RegisterEnabled
			{
				System::Boolean get();
			...
			/// </summary>
			property System::String^ DialPrefix
			{
				System::String^ get();
				void set(System::String^ value);
			}
			...
			/// </summary>
			property System::Boolean DialEscapePlus
			{
				System::Boolean get();
				void set(System::Boolean value);
			}
			...
			/// </summary>
			property System::Boolean PublishEnabled
			{
				System::Boolean get();
				void set(System::Boolean value);
			}
			...
			/// </summary>
			property System::String^ ContactParameters
			{
				System::String^ get();
				void set(System::String^ value);
			}
			...
			/// </summary>
			property System::String^ ContactUriParameters
			{
				System::String^ get();
				void set(System::String^ value);
			}
			...
			/// </summary>
			property System::Boolean AVPFEnabled
			{
				System::Boolean get();
				void set(System::Boolean value);
			}
